...
function TopExpense() {
  ...
  const handleDeleteExpense = (title) => {
    const updatedExpenses = expenseAllData.filter(
    ...
    <div>
      <div className="expense_wrapper">
        <div className="content_wrapper">
          ...
          <button className="btn_add" onClick={openModal1}>
            + Add Income
          </button>
        </div>
        ...
        <div className="content_wrapper">
          ...
          <button className="btn_add_1" onClick={openModal}>
            + Add Expense
          </button>
        </div>
      ...
      <div className="parent_wrapper">
                ...
                <div className="expense_list">
                  <div className="left_content">
                    ...
                    <div>
                      ...
                      <p className="text_list_2">
                        {formatDateToMonthName(data.date)}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="right_content">
                    ...
                    <div
                      ...
                      onClick={() => handleDeleteExpense(data.title)}
                    >
                      <TiDeleteOutline />
                    </div>
        ...
        <div className="right_div">
          <ResponsiveContainer width="100%" height={330}>
            <BarChart width={500} height={300} data={pieChartArray}>
